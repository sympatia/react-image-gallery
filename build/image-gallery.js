...
var ImageGallery = function (_React$Component) {
  ...
  function ImageGallery(props) {
    ...
    _this._renderThumbnailsContainer = function (ref, thumbsTranslate, thumbnails) {
      var thumbnailStyle = _this._getThumbnailStyle();
  ...
  _createClass(ImageGallery, [{
    ...
    value: function render() {
      ...
      var renderThumbnailsContainer = this.props.renderThumbnailsContainer || this._renderThumbnailsContainer;
        ...
        _react2.default.createElement(
          ...
          this.props.showThumbnails && _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              renderThumbnailsContainer(function (t) {
                return _this5._thumbnails = t;
              }, this.state.thumbsTranslate, thumbnails)
            )
          ),
...
ImageGallery.propTypes = {
  ...
  renderThumbnailsContainer: _propTypes2.default.func,
